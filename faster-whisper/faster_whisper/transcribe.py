...
class WhisperModel:
    ...
    def transcribe(
        ...
        while (
            ...
            detected_language, language_probability = all_language_probs[0]
            if (
                language_detection_threshold is None
                or language_probability > language_detection_threshold
            ):
                break
            detected_language_info.setdefault(detected_language, []).append(
        ...
        # If the detected language is not Korean, raise an error
        if detected_language != language:
            raise ValueError(f"Detected language is not Korean, but {detected_language}")
